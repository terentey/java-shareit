...
class ItemRequestControllerTest {
    ...
    void save_whenItemDtoIsNotValid_thenReturnIStatusIsBadRequest() {
        ...
        verify(service, never()).save(requestDtoRequest, 1L);
    }
    ...
    @SneakyThrows
    @Test
    void findAll_whenFromAndSizeIsNotNull_thenReturnListOfItemRequest() {
        requestDtoResponse.setId(1L);
    ...
    void findAll_whenFromIsNotPositiveOrZero_thenReturnStatusIsBadRequest() {
        ...
        verify(service, never()).findAll(anyInt(), anyInt(), anyLong());
    }
