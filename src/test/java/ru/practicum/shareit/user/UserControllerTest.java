...
class UserControllerTest {
    ...
    @SneakyThrows
    @Test
    void save_whenUserDtoIsValid_thenReturnUserDto() {
    ...
    @SneakyThrows
    @Test
    void save_whenNameIsBlank_thenReturnUserDto() {
        dto.setName("   ");
    ...
    @SneakyThrows
    @Test
    void save_whenEmailIsNotValid_thenReturnUserDto() {
        dto.setEmail("email");
    ...
    @SneakyThrows
    @Test
    void save_whenEmailIsEmpty_thenReturnUserDto() {
        dto.setEmail("");
    ...
    @SneakyThrows
    @Test
    void update_whenUserDtoIsValid_thenReturnUserDto() {
    ...
    @SneakyThrows
    @Test
    void update_whenEmailIsNotValid_thenReturnUserDto() {
        dto.setEmail("email");
        ...
        verify(service, never()).update(eq(dto), anyLong());
    }
